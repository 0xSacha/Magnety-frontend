    ...
    <div className={`${styles.pageContent}`}>
      ...
      <Formik
        initialValues={{
          ...
          symbol: "ZKEth",
          strategy: " 60% switching ETH strategy for the best APR + 40% Hedging to cover DeFi positions",
          type: "Public",
          min: 0.0001,
          max: 20,
          lockup: "3",
