...
const vault: NextPage = () => {
  ...
  const { vad } = router.query; /* vault address*/
  let addressdata = VDatabase["default"];
  if (vad !== undefined) {
        ...
        <div className={`${styles.head}`}>
          <div>
            <div className={`${styles.title}`}>
              ...
              <span className="fs-48" style={{ fontWeight: "bold" }}>
                {" "}
                {name}{" "}
              </span>
              <button
                style={{ cursor: "pointer" }}
                onClick={() => setonPopUp(true)}
              >
                EDIT
              </button>
            </div>
            ...
            <div className={`${styles.description}`}>
              <span className="fs-22" style={{ fontWeight: "400" }}>
              ...
              <div>
                {[...Array(Object.keys(addressdata.tags).length)].map(
                  (e, i) => {
                    return (
                      <span className="fs-20" style={{ fontWeight: "400" }}>
                        {"#" + addressdata.tags[i]}
                      </span>
                    );
                  },
          ...
          <div>
            <div className={`${styles.generalInformation}`}>
              ...
              <div>
                ...
                <div>
                  <div className="fs-28" style={{ color: "#0dab45" }}>
                    20.3%
                  </div>
                </div>
              </div>
              <div>
                ...
                <div>
                  <div className="fs-28" style={{ color: "#FF0000" }}>
                    {" "}
                    8 / 16
                  </div>
                </div>
          ...
          <div>
            <div className="bg__dotted">
              <div className={`${styles.assetManager}`}>
                ...
                <div>
                  <div>
                    <div className="fs-28" style={{ fontWeight: "semi-bold" }}>
                      Managed by
                      <Link href={"../user/" + assetManager}>
                        <a>{assetManager.substring(0, 5)}...</a>
                      </Link>
                    </div>
                  </div>
                  <div>
                ...
                <div className={` bg__dotted`} style={{ minHeight: "300px" }}>
                  <div className={`${styles.mint}`}>
                    <div className="fs-14" style={{ fontWeight: "bold" }}>
                      <div>{acccountAddress.substring(0, 7)}...</div>
                      <div className="fs-14 ">
                        &nbsp;&nbsp;&nbsp;
                        {isAllowedDepositor
                          ? "allowed depositor"
                  ...
                  <Flex direction={"column"} gap={"20px"} alignItems={"center"}>
                    ...
                    >
                      ...
                      {denominationAsset != "deno" && (
                        <Flex alignItems={"center"}>
                          ...
                          <div style={{ width: "30px" }}>
                            ...
                            <img
                              src={`require(../../image/${denominationAsset}.png)`}
                            />
                          </div>
                        </Flex>
                      )}
                      <Flex flexDir={"column"}>
                        <Text
                          ...
                          fontSize={"sm"}
                        >
                          Balance : ~{parseFloat(userBalance).toPrecision(2)}
                        </Text>
                      </Flex>
                    </Flex>
                    <Flex
                    ...
                    >
                      <Text
                        ...
                        width={"50%"}
                      >
                        {parseFloat(buyValue) / parseFloat(sharePrice) -
                          (parseFloat(buyValue) / parseFloat(sharePrice)) *
                      ...
                      <Flex flexDir={"column"}>
                        <Text color={"whiteAlpha.500"} fontSize={"sm"}>
                          {" "}
                          NFTs : ~{parseFloat(userShareBalance)}
                        </Text>
                      </Flex>
                    </Flex>
                    ...
                    <div className={`${styles.mint}`}>
                      ...
                      {userShareInfo.length != 0 &&
                        userShareInfo.map((p, index) => (
                          <div>
                            <div>tokenID : {p.tokenId}</div>
                            <div>Share amount: {p.shareAmount}</div>
                            <div>
                              <Button
                                backgroundColor={"#f6643c"}
                    ...
                    <div className={`${styles.mint}`}>
                      ...
                      >
                        ...
                        <SliderThumb
                          fontSize="sm"
                          boxSize="32px"
                          children={parseFloat(percentShare)}
                        />
                      </Slider>
                      <div>
                        {percentShare == "0" ? (
                          ...
                          <>
                            ...
                            {denominationAsset} including Performance and exit
                            fees
                          </>
                        )}
                      </div>
                      <div>
                        <div>Reedem funds with</div>
                        {onChange == true ? (
                          <div>
